...
public class CountryTest {
    ...
    public void createCountryNegative(){
        ...
        given()
                ...
                .statusCode(400)
                .body("message", containsString("already"))  // gelen body deki mesajı doğrulama
        ;
    }
    ...
    public void updateCountry(){
        ...
        countryName="New Austin"+faker.number().digits(7);
        country.put("name",countryName);
        country.put("code",faker.address().countryCode()+faker.number().digits(5));
    ...
    public void deleteCountryNegative(){
        given()
                ...
                .then()
                .log().body() // gelen body yi log olarak göster
                .statusCode(500) // jenkins için hatalı test yapıldı. normalde 400
